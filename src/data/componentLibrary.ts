...
export const componentLibrary: ComponentDefinition[] = [
  ...
  },
  {
    ...
    color: "#2563eb",
    footprint: { cols: 8, rows: 10 },
    visual: { kind: "display", label: "1.8TFT" },
  ...
  },
  {
    ...
    color: "#0f766e",
    footprint: { cols: 7, rows: 14 },
    visual: { kind: "display", label: "2.25" },
  ...
  },
  {
    ...
    visual: { kind: "actuator", label: "SPK" },
  ...
  },
  {
    ...
    color: "#f59e0b",
    footprint: { cols: 10, rows: 4 },
    visual: { kind: "module", label: "BAT" },
  ...
  },
  {
    ...
    color: "#0891b2",
    footprint: { cols: 5, rows: 4 },
    visual: { kind: "module", label: "USB-C" },
